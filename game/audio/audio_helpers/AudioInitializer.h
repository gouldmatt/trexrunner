 ...
 *		Includes all the functions needed to initialize the audio codec, ADAU1761 and other
 *		initializers needed for the project
 *
 *		IicConfig, AudioPllConfig, AudioWriteToReg, AudioConfigureJacks, LineinLineoutConfig, InitializeAudio are sourced from
 *		Zynqbook tutorial - Chapter 4: Adventures with IP
 *		Book: http://www.zynqbook.com/
 *		Source repository: https://github.com/alexvonduar/Zynq-Book-Tutorial-Source
 */

#ifndef SRC_AUDIO_HELPERS_AUDIOINITIALIZER_H_
#define SRC_AUDIO_HELPERS_AUDIOINITIALIZER_H_
...
#endif /* SRC_HELPERS_APPINITIALIZERS_H_ */
